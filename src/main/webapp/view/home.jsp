...
<c:forEach items="${productList}" var="p" varStatus="loop">
    ...
    <a href="/view/details.jsp"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSsYiduiVprpfIkkYqF1J6Cd8biBh2-ClgMqQ&usqp=CAU" height="220" width="220" alt=""></a>
    </div>
    <div class="p-footer">
