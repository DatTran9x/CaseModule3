...
<head>
    ...
    <link rel="stylesheet" href="/view/adminhomecss.css">
</head>
...
<div id="wrapper">
    ...
    <div id="header" class="center clearfix">
        <div id="logo" class="left">
            <a href="/view/adminhome.jsp">
                <img src="https://scontent.fhan3-2.fna.fbcdn.net/v/t1.6435-9/117229425_674141463187030_4941209283882753123_n.jpg?_nc_cat=107&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=UiCFfubFppgAX9f0JrR&_nc_ht=scontent.fhan3-2.fna&oh=00_AT_g8usbIlZ18vNs0iCxzXlbEXbT6fGR5S1NGVo5CSir7g&oe=61F40071"
                     height="60" width="61" alt="">
        ...
        <div class="home-bg">
            <div class="center">
                ...
                <ul class="breadcrumbds clearfix">
                    <li><a href="/admin">Home</a><span class="sp">&raquo;</span></li>
                    <li><a href="/admin">Shop</a><span class="sp">&raquo;</span></li>
    ...
    <div class="sorting center clearfix">
        ...
        <div class="sel-sorting">
            <span>Sort by: </span>
            <button>
                <a href="/admin?action=sortUp"> Price from H to L </a>
            </button>
            <button>
                <a href="/admin?action=sortDown"> Price from L to H </a>
           </button>
    ...
    <div class=" middle clearfix center">
                    ...
                    <div class="s-products">
                        <div class="s-products-item clearfix">
                            <div class="s-products-img">
                                <a href="/view/details.jsp"><img
                                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSsYiduiVprpfIkkYqF1J6Cd8biBh2-ClgMqQ&usqp=CAU"
                                        alt=""></a>
                            </div>
                        ...
                        <div class="s-products-item clearfix">
                            <div class="s-products-img">
                                <a href="/view/details.jsp"><img
                                        src="https://cf.shopee.vn/file/0e8b55d9aaaab93554472b4a61a07e58" alt=""></a>
                            </div>
                            <div class="s-products-info">
                ...
                <div class="content">
                    <div class="product-catalog clearfix">
                        <div class="products">
                            <div class="p-img">
                                <a href="admin?action=showAddProductForm"><img
                                        src="https://clipartion.com/wp-content/uploads/2016/04/best-math-clipart-black-and-white-clipartion-com.gif"
                                        height="220" width="220" alt=""></a>
                            </div>
                            <div class="p-footer">
                                <br><br><br>
                                    ...
                                    <div class="col-span-4">
                                        <div class="products">
                                            <div class="p-img">
                                                ...
                                                <a href="/admin?action=showProduct&id_product=${p.id}"><img src="${p.img}" height="220" width="220"
                                                                                 alt=""></a>
                                            </div>
                                            <div class="p-footer">
                                                <h6><a href="/admin?action=showProduct&id_product=${p.id}"> ${p.name} </a>
                                                    ...
                                                    <div class="p-footer-price clearfix">
                                                        ...
                                                        <a href="/admin?action=showEditProductForm&id_product=${p.id}"
                                                           class="right add-cart">Edit</a>
                                                        <a href="/admin?action=showDeleteProductForm&id_product=${p.id}"
                                                           class="right add-cart">Remove</a>
                                                    </div>
                                                </h6>
                                            </div>
                                        </div>
        ...
        <div class="center clearfix">
            ...
            <div class="f-populars">
                ...
                <div class="s-products-item clearfix">
                    <div class="s-products-img">
                        <a href="#"><img
                                src="https://cdn.cliqueinc.com/posts/284945/spring-jacket-trends-284945-1579285134572-main.700x0c.jpg"
                                alt=""></a>
                    </div>
                    <div class="s-products-info">
