...
<div id="wrapper">
        ...
        <div class="home-bg">
            <div class="center">
                ...
                <ul class="breadcrumbds clearfix">
                    ...
                    <li><a href="/view/adminhome.jsp">Shop</a><span class="sp">&raquo;</span></li>
    ...
    <div class=" middle clearfix center">
        <div class="sidebar">
            ...
            <h4 class="s-title">Search our user <span class="s-title-br"></span></h4>

            <form action="/user?action=findUser" class="s-search" method="post">
        ...
        <div class="content">
            <div class="product-catalog clearfix">
                <div class="products">
                    ...
                    <div class="p-footer">
                        <br><br><br>
                        <h6><a href="/admin?action=showAddProductForm"> Add new user </a></h6>
                    </div>
                </div>
                            ...
                            <div class="col-span-4">
                                <div class="products">
                                    <div class="p-footer">
                                        <h6>
                                            <p>${p.id}</p>
                                            <a href="/view/details.jsp"> ${p.name} </a>
                                            <div class="rate">
                                                <div style="width: 80%;"></div>
                                            </div>
                                            <p> ${p.phoneNumber} </p>
                                            <p> ${p.email} </p>
                                            <p> ${p.password}</p>
                                                <a href="/user?action=showEditProductForm&id_product=${p.id}"
                                                   class="right add-cart">Edit</a>
                                                <a href="/user?action=showDeleteProductForm&id_product=${p.id}"
