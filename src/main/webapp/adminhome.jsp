        ...
        <div class="home-bg">
            <div class="center">
                ...
                <ul class="breadcrumbds clearfix">
                    ...
                    <li><a href="/adminhome.jsp">Shop</a><span class="sp">&raquo;</span></li>
        ...
        <div class="content">
            <div class="product-catalog clearfix">
                <div class="products">
                    ...
                    <div class="p-footer">
                        <br><br><br>
                        <h6><a href="/create.jsp"> Add new product </a></h6>
                    </div>
                </div>
                ...
                <div class="products">
                    <div class="p-img">
                        <a href="/edit.jsp"><img src="https://jemcloset.com/wp-content/uploads/2021/01/1861X.jpg" height="220" width="220" alt=""></a>
                    </div>
                    <div class="p-footer">
                        <h6><a href="/edit.jsp"> Black Air Sweater </a></h6>
                ...
                <div class="products">
                    <div class="p-img">
                        <a href="/edit.jsp"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXALRg2YjFuqKxoBdRf_PM8379Txs2g2sbNg&usqp=CAU" height="220" width="220" alt=""></a>
                    </div>
                    <div class="p-footer">
                        <h6><a href="/edit.jsp"> Smile Nirvana T-Shirt </a></h6>
                ...
                <div class="products">
                    <div class="p-img">
                        <a href="/edit.jsp"><img src="https://www.talkbeauty.vn/public/assets/article_dir/2020/05/phu-kien-thoi-trang-17.jpg" height="220" width="220" alt=""></a>
                    </div>
                    <div class="p-footer">
                        <h6><a href="/edit.jsp"> White Bandana </a></h6>
                ...
                <div class="products">
                    <div class="p-img">
                        <a href="/edit.jsp"><img src="https://i.pinimg.com/474x/00/3e/8c/003e8c38c5c9bee17cadd7cf6df60146.jpg" height="220" width="220" alt=""></a>
                    </div>
                    <div class="p-footer">
                        <h6><a href="/edit.jsp"> ZARA Jeans </a></h6>
                ...
                <div class="products">
                    <div class="p-img">
                        <a href="/edit.jsp"><img src="https://filebroker-cdn.lazada.vn/kf/S7403f53979eb40c58917612bc46f33f4y.jpg" height="220" width="220" alt=""></a>
                    </div>
                    <div class="p-footer">
                        <h6><a href="/edit.jsp"> LEVI'S Jeans </a></h6>
