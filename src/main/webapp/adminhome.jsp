...
<div id="wrapper">
    ...
    <div class="middle clearfix center">
        <div class="sidebar">
            ...
            <div class="s-products">
                <div class="s-products-item clearfix">
                    <div class="s-products-img">
                        <a href="#"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSsYiduiVprpfIkkYqF1J6Cd8biBh2-ClgMqQ&usqp=CAU" alt=""></a>
                    </div>
                    <div class="s-products-info">
                        <h6><a href="#"> Bape Purple Hodie </a></h6>
                        <div class="rate">
                ...
                <div class="s-products-item clearfix">
                    <div class="s-products-img">
                        <a href="#"><img src="https://cf.shopee.vn/file/0e8b55d9aaaab93554472b4a61a07e58" alt=""></a>
                    </div>
                    <div class="s-products-info">
                        <h6><a href="#"> Drew House Shirt </a></h6>
                        <div class="rate">
                            <div style="width: 80%;"></div>
                        </div>
                        <span class="comments"><i class="ic-comment"></i> 99 people bought </span>
            ...
            <ul class="cat-list">
                <li><a href="#"> T-SHIRT </a><span>(5)</span></li>
                <li><a href="#"> SWEATER </a><span>(3)</span></li>
                <li><a href="#"> JACKET </a><span>(8)</span></li>
                <li><a href="#"> JEANS </a><span>(12)</span></li>
                <li><a href="#"> OTHERS </a><span>(7)</span></li>
            </ul>
        ...
        <div class="content">
            <div class="product-catalog clearfix">
                <div class="products">
                    <div class="p-img">
                        <a href="#"><img src="https://clipartion.com/wp-content/uploads/2016/04/best-math-clipart-black-and-white-clipartion-com.gif" height="220" width="220" alt=""></a>
                    </div>
                    <div class="p-footer">
                        <br><br><br>
                        <h6><a href="#"> Add new product </a></h6>
                    </div>
                </div>
                ...
                <div class="products">
                    <div class="p-img">
                        <a href="#"><img src="https://jemcloset.com/wp-content/uploads/2021/01/1861X.jpg" height="220" width="220" alt=""></a>
                    </div>
                    <div class="p-footer">
                        <h6><a href="#"> Black Air Sweater </a></h6>
                        ...
                        <div class="p-footer-price clearfix">
                            ...
                            <a href="#" class="right add-cart">Edit</a>
                ...
                <div class="products">
                    <div class="p-img">
                        <a href="#"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXALRg2YjFuqKxoBdRf_PM8379Txs2g2sbNg&usqp=CAU" height="220" width="220" alt=""></a>
                    </div>
                    <div class="p-footer">
                        <h6><a href="#"> Smile Nirvana T-Shirt </a></h6>
                ...
                <div class="products">
                    <div class="p-img">
                        <a href="#"><img src="https://www.talkbeauty.vn/public/assets/article_dir/2020/05/phu-kien-thoi-trang-17.jpg" height="220" width="220" alt=""></a>
                    </div>
                    <div class="p-footer">
                        <h6><a href="#"> White Bandana </a></h6>
                ...
                <div class="products">
                    <div class="p-img">
                        <a href="#"><img src="https://i.pinimg.com/474x/00/3e/8c/003e8c38c5c9bee17cadd7cf6df60146.jpg" height="220" width="220" alt=""></a>
                    </div>
                    <div class="p-footer">
                        <h6><a href="#"> ZARA Jeans </a></h6>
                ...
                <div class="products">
                    <div class="p-img">
                        <a href="#"><img src="https://filebroker-cdn.lazada.vn/kf/S7403f53979eb40c58917612bc46f33f4y.jpg" height="220" width="220" alt=""></a>
                    </div>
                    <div class="p-footer">
                        <h6><a href="#"> LEVI'S Jeans </a></h6>
